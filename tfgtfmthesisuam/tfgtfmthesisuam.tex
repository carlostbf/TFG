...
\levelin{Doble Grado en Ingeniería Informática y Matemáticas}
...
\author{Carlos Li Hu}
\copyrightdate{X de Noviembre de 2019}
\begin{comment}
...
\chapter{Estética\label{CAP:ESTETICA}}{estetica/estetica} %Introducción
  \section{Tipo de documento\label{SEC:TIPODOC}}{estetica/tipodocumento} %Motivacion
  \section{Gama de colores\label{SEC:GAMASEL}}{estetica/gamacolores} %Objetivos
  \section{Colores\label{SEC:COLORES}}{estetica/colores} %Organización de la memoria
  \section{Uso de los colores\label{SEC:USOCOLORES}}{estetica/usocolores}

\chapter{Estructura\label{CAP:ESTRUCTURA}}{estructura/estructura} %Estado del arte
...
\chapter{Primeros pasos\label{CAP:PRIMEROSPASOS}}{primpas/primpas} %Diseño
...
\chapter{Elementos internos\label{CAP:ELEMINT}}{elemint/elemint} %Desarrollo
...
\chapter{Compilación\label{CAP:COMPILACION}}{varios/compilacion}%Integración, pruebas y resultados
