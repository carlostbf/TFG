...
\documentclass[epsbased,copyright,final,printable,covers,extendedindex,firstnumbered,tfg,gnuplot,nonelo]{tfgtfmthesisuam}
...
\chapter{Diseño\label{CAP:DISEÑO}}{diseno/diseno}
  ...
  \section{Dificultades Encontradas\label{SEC:DIFICULTAD}}{diseno/dificultad}
